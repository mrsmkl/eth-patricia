...
//    var cell = await web3.eth.getStorageCell(blk.hash, store.options.address, "0x"+hash(make32("12000023000034000045000056")).toString("hex"))
    var cell = await web3.eth.getStorageCell(blk.hash, store.options.address, make32("12000023000034000045000056"))
